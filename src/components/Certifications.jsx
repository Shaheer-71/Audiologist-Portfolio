...
export default function Certifications() {
  return (
    <section id="certifications" style={{ padding: '108px 0', background: 'var(--surface)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              {education.map((edu, i) => (
                <motion.div
                  ...
                  onMouseEnter={e => e.currentTarget.style.borderColor = 'var(--cm-purple-border)'}
                  onMouseLeave={e => e.currentTarget.style.borderColor = 'var(--border)'}
                >
                ...
                <div style={{ display: 'flex', gap: 12 }}>
                  {[
                    ...
                    <div key={l.lang} style={{
                      ...
                      <div style={{ fontSize: 11, color: 'var(--text-dim)', marginTop: 4 }}>{l.level}</div>
                    </div>
                  ))}
                </div>
              </motion.div>
